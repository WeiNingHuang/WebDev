...
<template >
    ...
    <div class="quLayer" v-show="quflag">
        <div class="mask">
            <div class="question" style="border: 1px solid blue;">
                <!-- <span>第{{ quIndex + 1 }}題</span> -->
                <label for="">題號</label>
                <input type="text" v-model="newQu.quId">
                <label for="">問題</label>
                <input type="text" placeholder="請輸入問題" v-model="newQu.qnTitle">
                <label for="">題型</label>
                <select name="" id="" v-model="newQu.optionType">
                    <option value="">請選擇</option>
                    <option value="single">單選題</option>
                    <option value="multi">多選題</option>
                    <option value="text">簡答題</option>
                </select>
                <input type="checkbox" name="isNecessary" id="" v-model="newQu.necessary">必填
                <label for="">選項</label>
                <input type="text" v-model="newQu.option">
                <button type="button" @click="createQu()">加入</button>
            </div>
            <div class="table">
                <table cellpadding="5" style="width:80%">
                    <thead>
                    ...
                    <tbody v-for="(qu, index) in quList" :key="qu.id">
                        <tr>
                            <td><input type="checkbox" name="" id=""></td>
                            <td>{{ qu.quId }}</td>
                            <td>{{ qu.qnTitle }}</td>
